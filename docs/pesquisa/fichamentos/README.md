...
| CARVALHO (2025) — frontend do sistema da UFU | experiência | [`carvalho-2025.md`](carvalho-2025.md) |
...
| No documento do projeto | Na fonte, no mesmo endereço |
|---|---|
| BASSO, F. et al. Inovação no acompanhamento de egressos [...] percepção de coordenadores de curso. ERES, 2024 | **SILVA, M. E. L.; FERREIRA, M. S.; RIBEIRO, B. M.; QUINCOZES, C. B.; FINGER, A. F.; DE MELLO, A. V.** (Unipampa). Subtítulo: "perspectiva dos **gestores**". Santiago/RS, p. 118-127 |
| COSTA, E. S.; DIAS, T. M. R. Plataforma RAEG [...] Revista Científica em EPT, Vitória, 2023 | **PRAGA DE SOUZA, O.; COUTO ASSIS, G.; DE SOUZA COSTA, E.** (CEFET-MG). *Educação Profissional e Tecnológica em Revista*, v. 8, n. Especial, p. 80-95, **2025** |
| COSTA, R. Inserção e trajetória profissional dos egressos de Estatística da UFOP. 2020 | **FERREIRA, V. M. S. R.**, **2026**. Subtítulo omitido: "uma análise a partir da plataforma **LinkedIn**" |
| CABRAL, T.; SILVA, L.; PACHECO, R. Arquitetura frontend [...] UFU, 2016 | **CARVALHO, L. A. da S.**, TCC, **2025**. A obra de Cabral, Silva e Pacheco (2016) existe na literatura, mas **não é a que está neste link** |
| SILVEIRA, R. et al. Desenvolvimento de uma ferramenta computacional [...] Unipar, 2019 | **RANTHUM, G.; SANTOS JUNIOR, G. dos**, *Educere et Educare*, v. 23, n. 1, **2023**. Título omite o recorte "da pós-graduação stricto sensu" |
| LOUSADA, A. C. Z.; MARTINS, D. Acompanhamento de egressos como instrumento de gestão. Redalyc, 2019 | **COELHO, M. C. de R.; SILVA, J. P. da** (EMESCAM). *Textos & Contextos*, v. 16, n. 2, p. 470-478, **2017**. Redalyc é o repositório, não o periódico. Lousada e Martins existem, em obra de **2005**, que não é esta |

### Data incorreta

| No documento do projeto | Na fonte |
|---|---|
| IFTO. Política de proteção de dados pessoais. Palmas, **2021** | PDF assinado eletronicamente em **27/12/2023**. Pode haver versão anterior, mas a acessível é a de 2023 |
| IFSP. Acompanhamento dos egressos. São Paulo, **2022** | Página publicada em 29/03/2020 e atualizada em 05/03/2026. Conteúdo vivo: citar pela data de consulta |

### Imprecisões menores

| No documento do projeto | Na fonte |
|---|---|
| SILVA, **A.** et al. Sistemas de acompanhamento [...] RSD, 2022 | Primeira autora é **Eunice Cristina da Silva** — inicial E. Falta o subtítulo "uma revisão integrativa" |
| UnB. Egressos RAIS. Brasília: **CEMEFEF**/UnB, 2019 | Produzido por **CIG/DAI/Decanato de Planejamento e Orçamento**, no projeto AvaliaUnB da CPA. O CEMEFEF apenas hospeda o arquivo |

### Conferidas e corretas

LGPD · SINAES · IFSP RN nº 13/2022 · IFES 2025 · Alvares, Loutfi e Campos (2020) ·
Davis (1989) · Alumni USP.

## Pendências levantadas

**Fontes citadas no projeto que precisam de nova leitura**

- **FERREIRA (2026)** foi fichada pelo resumo e metadados do repositório: o PDF não
  permitiu extração de texto por nenhum meio disponível. Ler integralmente antes de
  citar.
